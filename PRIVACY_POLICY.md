...
- **Order Information**: Purchase history, payment method (we do NOT store payment card details).
- **Device Information**: Basic device info to improve app performance.
...
## Data Storage
Your data is stored securely on our servers. We use industry-standard security measures to protect your information.
